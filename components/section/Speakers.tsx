              ...
              <div className="relative flex flex-col items-center justify-center bg-black rounded-tl-3xl rounded-br-3xl  p-4">
                ...
                <div className=" max-w-xs mt-6 rounded-tr-xl text-left ">
                  ...
                  <h2 className="text-muted-foreground text-lg mb-4  ">
                    Lead UX Designer at Acme Corp
                  </h2>
                  <p className="text-sm">
                    Alex is a passionate UX designer with 10 years of experience
                    crafting intuitive and user-centered designs. He specializes
                    in designing mobile-first experiences and has a deep
